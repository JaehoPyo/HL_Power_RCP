...
type
  ...
  public
    ...
    function  fnCanInput: Boolean;                                              // 창고 자리 있는지 여부
    function  fnCanOutput: Boolean;                             // 창고 빈 칸 갯수 반환
...
begin
  ...
  begin
    ...
    begin
      ...
      if (PLC_WriteVal.RFID_Read[i] = '1') and ((PLC_ReadVal.RFID_Read[i] = '0'))then
      begin
        PLC_ORDER.ORDER := '1';
        PLC_WRITE_FLAG := ComWrite;
        PLC_WriteVal.RFID_Read[i] := '0';
